...
<div class="poly-schedule-header">
    ...
    <div class="poly-three-parts poly-fl poly-title-part"><input id="poly-schedule-title" class="poly-schedule-title" name="schedule-title" maxlength="250" placeholder="Enter schedule title" type="text"></div>
...
<div class="poly-empty-project-list-alert">
    <h3>You don't have projects in this schedule yet!</h3>
</div>

<div class="poly-project-wrapper">
    <aside class="poly-project-sidebar">
        <div>
            <a id="poly-add-project-button" class='button-secondary poly-add-project-button poly-glazzed-btn poly-glazzed-btn-green' href='#' title='Add new'>+ Add project</a>
        </div>
        ...
        <div class="poly-project-details-wrapper">
            <aside class="poly-project-details-sidebar">
                <div id="poly-project-details-content">
                    <input id="poly-project-title" class="poly-project-title" name="project.title" value="" type="text" placeholder="Enter project title">
                    ...
                    <textarea id="poly-project-description" name="project.description" placeholder="Enter project description..."></textarea>
                    <input id="poly-project-url" name="project.url" value="" type="text" placeholder="Enter project URL">
                </div>
            </aside>
...
function poly_updateModel(){
  //To make sure it's valid JS object
    ...
    poly_schedule.extoptions = {
        all_cats: {},
        type: '<?php echo POLYGridType::SCHEDULE; ?>'
    };
