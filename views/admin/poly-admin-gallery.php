...
<div class="poly-schedule-header">
    ...
    <div class="poly-three-parts poly-fl poly-title-part"><input id="poly-schedule-title" class="poly-schedule-title" name="schedule-title" maxlength="250" placeholder="Enter gallery title" type="text"></div>
...
<div id="poly-category-bar">

</div>

<div class="poly-gallery-wrapper">
    <div class="poly-add-item-boxes">
        <div class="poly-add-item-box"><a id="poly-add-picture-button" class='button-secondary poly-add-project-button poly-glazzed-btn poly-glazzed-btn-green' href='#' title='Add new picture'>+ Add picture</a></div>
        <div class="poly-add-item-box"><a id="poly-add-video-button" class='button-secondary poly-add-project-button poly-glazzed-btn poly-glazzed-btn-green poly-tooltip' href='#' title='<?php echo htmlentities('<div class="poly-tooltip-content">Upgrade to Premium version for Local Videos</div>'); ?>'>+ Add video (PRO)</a></div>
        <div class="poly-add-item-box"><a id="poly-add-youtube-button" class='button-secondary poly-add-project-button poly-glazzed-btn poly-glazzed-btn-green poly-tooltip' href='#' title='<?php echo htmlentities('<div class="poly-tooltip-content">Upgrade to Premium version for Youtube Videos</div>'); ?>'>+ Add youtube (PRO)</a></div>
        <div class="poly-add-item-box"><a id="poly-add-vimeo-button" class='button-secondary poly-add-project-button poly-glazzed-btn poly-glazzed-btn-green poly-tooltip' href='#' title='<?php echo htmlentities('<div class="poly-tooltip-content">Upgrade to Premium version for Vimeo Videos</div>'); ?>'>+ Add vimeo (PRO)</a></div>
        <div class="poly-add-item-box"><a id="poly-add-iframe-button" class='button-secondary poly-add-project-button poly-glazzed-btn poly-glazzed-btn-green poly-tooltip' href='#' title='<?php echo htmlentities('<div class="poly-tooltip-content">Upgrade to Premium version for iFrames</div>'); ?>'>+ Add iframe (PRO)</a></div>
        <div class="poly-add-item-box"><a id="poly-add-map-button" class='button-secondary poly-add-project-button poly-glazzed-btn poly-glazzed-btn-green poly-tooltip' href='#' title='<?php echo htmlentities('<div class="poly-tooltip-content">Upgrade to Premium version for Maps</div>'); ?>'>+ Add map (PRO)</a></div>
    </div>
    ...
    html +=
        '<tr id="poly-gallery-project-' + poly_project.id + '" data-id="' + poly_project.id + '" class="poly-gallery-project">' +
            ...
            '<td class="poly-content">' +
                '<div class="poly-content-box"><input type="text" placeholder="Enter title" name="project.title" value=""></div>' +
                '<div class="poly-content-box"><input type="text" placeholder="Enter link (http://domain.com)" name="project.url" value=""></div>' +
                '<div class="poly-content-box"><textarea rows=3 placeholder="Enter description" name="project.description"></textarea></div>' +
            '</td>' +
...
function poly_updateModel(){
    ...
    poly_schedule.extoptions = {
        all_cats: {},
        type: '<?php echo POLYGridType::GALLERY; ?>'
    };
