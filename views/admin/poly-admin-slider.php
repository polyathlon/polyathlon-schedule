...
<div class="poly-schedule-header">
    ...
    <div class="poly-three-parts poly-fl poly-title-part"><input id="poly-schedule-title" class="poly-schedule-title" name="schedule-title" maxlength="250" placeholder="Enter slider title" type="text"></div>
...
//        handle: 'span'
    ...
    function poly_updateModel(){
        ...
        poly_schedule.extoptions = {
            all_cats: {},
            type: '<?php echo POLYGridType::SLIDER; ?>'
        };
        ...
        jQuery(".poly-gallery-project").each(function(key, elem){
            ...
            poly_activeProject.description = '';
