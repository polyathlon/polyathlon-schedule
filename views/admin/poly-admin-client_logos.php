...
<div class="poly-schedule-header">
    ...
    <div class="poly-three-parts poly-fl poly-title-part"><input id="poly-schedule-title" class="poly-schedule-title" name="schedule-title" maxlength="250" placeholder="Enter clients name" type="text"></div>
...
<div class="poly-gallery-wrapper poly-client-logos-wrapper">
    <div class="poly-add-item-boxes">
        <div class="poly-add-item-box"><a id="poly-add-picture-button" class='button-secondary poly-add-project-button poly-glazzed-btn poly-glazzed-btn-green' href='#' title='Add new client'>+ Add client</a></div>
    </div>
...
//        handle: 'span'
    ...
    function poly_updateModel(){
        ...
        poly_schedule.extoptions = {
            all_cats: {},
            type: '<?php echo POLYGridType::CLIENT_LOGOS; ?>'
        };
    ...
    function onScheduleOptions() {
        if (poly_schedule.isDraft) {
            ...
            var href = "?page=" + poly_adminPage + "&action=options&id=" + poly_schedule.id+'&type=<?php echo POLYGridType::CLIENT_LOGOS; ?>';
            poly_loadHref(href);
        }
    }
</script>
